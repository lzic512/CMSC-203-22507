...
public class CryptoManager {
	...
	public static String encryptCaesar(String plainText, int key)
	{
		...
		for(int i=0;i<plainText.length();i++)
		{
				coolthing+=Character.toString((char) ((int)plainText.charAt(i)+key));
		}
		return coolthing;
	}
	/**
	...
	public static String decryptCaesar(String encryptedText, int key)
	{
		...
		{
			coolthing+=Character.toString((char) ((int)encryptedText.charAt(i)-key));
		}
		return coolthing;
	}
	...
	coolthing+=Character.toString(c);
	}
	return coolthing;
	}
